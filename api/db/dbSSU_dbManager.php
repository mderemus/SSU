...
function getConnection() {
	...
	global $db_SSU_db_Url, $db_SSU_db_User, $db_SSU_db_Pass, $db_SSU_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_SSU_db_Url.";dbname=".$db_SSU_db_DbName, $db_SSU_db_User, $db_SSU_db_Pass);
