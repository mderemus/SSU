...
const routes: Routes = [
    ...
    { path: 'accounts/:id',  component: AccountEditComponent , canActivate: [AuthGuard] },
    { path: 'accounts',  component: AccountListComponent , canActivate: [AuthGuard] },
    { path: 'cashflows/:id',  component: CashFlowEditComponent , canActivate: [AuthGuard] },
    { path: 'cashflows',  component: CashFlowListComponent , canActivate: [AuthGuard] },
